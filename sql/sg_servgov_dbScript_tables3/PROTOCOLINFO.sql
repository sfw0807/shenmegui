DROP TABLE ESB.PROTOCOLINFO;
CREATE TABLE ESB.PROTOCOLINFO  ( 
...
;
COMMENT ON TABLE ESB.PROTOCOLINFO IS '接入系统协议信息表'
;
COMMENT ON COLUMN ESB.PROTOCOLINFO.SYSID IS '系统ID'
;
COMMENT ON COLUMN ESB.PROTOCOLINFO.CONNECTMODE IS '协议类型'
;
COMMENT ON COLUMN ESB.PROTOCOLINFO.SYSADDR IS '访问地址'
;
COMMENT ON COLUMN ESB.PROTOCOLINFO.APPSCENE IS '应用场景'
;
COMMENT ON COLUMN ESB.PROTOCOLINFO.MESSAGETYPE IS '报文类型'
;
COMMENT ON COLUMN ESB.PROTOCOLINFO.TIMEOUT IS '超时时间'
;
COMMENT ON COLUMN ESB.PROTOCOLINFO.SYSTYPE IS '系统类型'
;
COMMENT ON COLUMN ESB.PROTOCOLINFO.CODETYPE IS '编码格式'
;
COMMENT ON COLUMN ESB.PROTOCOLINFO.MACFLAG IS 'MAC校验'
;
COMMENT ON COLUMN ESB.PROTOCOLINFO.CURRENTTIMES IS '并发数'
;
COMMENT ON COLUMN ESB.PROTOCOLINFO.AVGRESTIME IS '承诺平均响应时间(S)'
;
COMMENT ON COLUMN ESB.PROTOCOLINFO.SUCCESSRATE IS '承诺成功率(%)'
;
INSERT INTO ESB.PROTOCOLINFO(SYSID, CONNECTMODE, SYSADDR, APPSCENE, MESSAGETYPE, TIMEOUT, SYSTYPE, CODETYPE, MACFLAG, CURRENTTIMES, AVGRESTIME, SUCCESSRATE)

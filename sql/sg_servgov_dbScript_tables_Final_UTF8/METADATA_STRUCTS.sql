...
CREATE TABLE  METADATA_STRUCTS  ( 
	STRUCTID  	VARCHAR(50) NOT NULL,
	STRUCTNAME	VARCHAR(100),
	REMARK    	VARCHAR(500) 
	)
;
COMMENT ON TABLE  METADATA_STRUCTS IS '元数据结构基本信息表'
;
COMMENT ON COLUMN  METADATA_STRUCTS.STRUCTID IS '结构体ID'
;
COMMENT ON COLUMN  METADATA_STRUCTS.STRUCTNAME IS '结构体名称'
;
COMMENT ON COLUMN  METADATA_STRUCTS.REMARK IS '结构体描述'
;
INSERT INTO  METADATA_STRUCTS(STRUCTID, STRUCTNAME, REMARK)

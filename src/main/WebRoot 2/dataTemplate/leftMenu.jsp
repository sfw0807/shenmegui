...
%>
 <div class="tree-filter">
  ...
  <ul class="easyui-tree mxservicetree" data-options="url:'/dataTemplate/tree.json',method:'get',animate:true"></ul>
...
%>
<ul id="menu-tree">
  <li><a href="javascript:;" class="openable">交易节点管理</a> </li>
  <li><a href="javascript:;" class="openable">血缘分析</a></li>
</ul>
<%
	}

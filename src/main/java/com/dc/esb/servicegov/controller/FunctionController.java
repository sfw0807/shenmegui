...
import com.dc.esb.servicegov.vo.FunctionTreeVO;
import com.dc.esb.servicegov.vo.FunctionVO;
...
public class FunctionController {
    ...
    public
    @ResponseBody
    List<FunctionTreeVO> getAllFunction(@PathVariable String roleId) {
    ...
    public
    @ResponseBody
    boolean saveFunction(@RequestBody String[] param) {
    ...
    public
    @ResponseBody
    boolean deleteFunction(@PathVariable String functionId) {

...
import com.dc.esb.servicegov.excel.impl.SysInvokeExcelGenerator;
import com.dc.esb.servicegov.exception.DataException;
import com.dc.esb.servicegov.service.TransStateManager;
...
public class InvokeInfoController {
    ...
    public
    @ResponseBody
    List<SystemInvokeServiceInfo> getSystemServiceInvokeInfo(
    ...
    public
    @ResponseBody
    List<InvokeInfoVo> getAllInvokeInfo() {
    ...
    public
    @ResponseBody
    boolean saveInvokeInfo(@RequestBody String[] param) {
    ...
    public
    @ResponseBody
    List<System> getConsumer(@RequestBody String[] param) {
        String operationId = param[0];
...
//		paramMap.put("consumeMsgType", consumeMsgType);
    ...
    public
    @ResponseBody
    boolean addConsumer(@RequestBody String[] param) {

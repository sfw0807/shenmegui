...
public class ServiceCategoryController {
    ...
    public
    @ResponseBody
    List<ServiceCategory> getAllOperationInfo() {
    ...
    public
    @ResponseBody
    List<ServiceTotalVO> getServiceTotalInfos() {
    ...
    public
    @ResponseBody
    List<ServiceCategory> getFirstLevelInfo() {
    ...
    public
    @ResponseBody
    List<ServiceCategory> getSecondLevelInfo() {

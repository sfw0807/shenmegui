...
import com.dc.esb.servicegov.excel.impl.ServiceDetailExcelGenerator;
import com.dc.esb.servicegov.excel.impl.SvcAsmRelateExcelGenerator;
...
public class SvcAsmRelateController {
    ...
    public
    @ResponseBody
    List<SvcAsmRelateInfoVO> getAllExportInvokeInfos() {
    ...
    public
    @ResponseBody
    List<SvcAsmRelateInfoVO> getAllSvcAsmRelateInfo() {
    ...
    public
    @ResponseBody
    List<SvcAsmRelateInfoVO> getAllServiceDetailsInfo() {

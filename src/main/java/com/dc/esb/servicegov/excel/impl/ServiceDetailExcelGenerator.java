...
import com.dc.esb.servicegov.service.impl.SvcAsmRelateManagerImpl;
import com.dc.esb.servicegov.vo.SvcAsmRelateInfoVO;

@Service
@Transactional
public class ServiceDetailExcelGenerator implements IConfigGenerater<Object, SvcAsmRelateInfoVO>{

	private Log log = LogFactory.getLog(ServiceDetailExcelGenerator.class);
	Workbook wb;
	Sheet sheet;
	private CellStyle headCellStyle;
	private CellStyle bodyCellStyle;
	public static final String fileName = "serviceDetail.xls";
	@Autowired
	...
	public List<SvcAsmRelateInfoVO> getExportDataByConditions(
		...
		// TODO Auto-generated method stub
		return svcAsmRelateManager.getServiceDetailsInfoByConditions(mapConditions);
	}

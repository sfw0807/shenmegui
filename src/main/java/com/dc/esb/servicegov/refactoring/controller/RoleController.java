...
import com.dc.esb.servicegov.refactoring.vo.RoleVO;
...
public class RoleController {
	...
	public @ResponseBody List<RoleVO> getAll() {
	...
	public @ResponseBody boolean saveRole(@RequestBody String[] param) {
		Role role = new Role();
	...
	public @ResponseBody boolean saveRole(@PathVariable String param) {
	...
	public @ResponseBody boolean assignFunction(@RequestBody String[] param) {

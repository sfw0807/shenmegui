...
import com.dc.esb.servicegov.refactoring.excel.impl.TranConsumerCountExcelGenerator;
import com.dc.esb.servicegov.refactoring.excel.impl.TranProviderCountExcelGenerator;
import com.dc.esb.servicegov.refactoring.tranlink.DBUtil;
import com.dc.esb.servicegov.refactoring.tranlink.ExcelParse;
import com.dc.esb.servicegov.refactoring.util.GlobalImport;
import com.dc.esb.servicegov.refactoring.vo.TranCountVO;
...
public class TranImportController {
	...
	public @ResponseBody List<TranCountVO> getTranCount() throws Exception {
	...
	public @ResponseBody boolean exportTranProviderExcel(HttpServletRequest request,
...
//			mapper.disable(DeserializationConfig.Feature.FAIL_ON_UNKNOWN_PROPERTIES);
	...
	public @ResponseBody boolean exportTranConsumerExcel(HttpServletRequest request,
			HttpServletResponse response,
			@PathVariable String params) throws UnsupportedEncodingException{
//		try {
//			request.setCharacterEncoding("UTF-8");

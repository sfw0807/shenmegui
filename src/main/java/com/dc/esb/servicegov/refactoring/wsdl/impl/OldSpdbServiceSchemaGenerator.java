 ...
 * compare to new xsd:
 * s<-->d
 * remove shead from xml
 */
@Component
public class OldSpdbServiceSchemaGenerator implements WSDLGenerator<List<Service>> {

    private static final Log log = LogFactory.getLog(OldSpdbServiceSchemaGenerator.class);
...
//          String headServiceId = serviceHeadRelateDAO.findUniqueBy("serviceId", serviceDO.getServiceId()).getSheadId();
            ...
            metadataImportElem.addAttribute("schemaLocation", "http://10.112.20.145:8080/Publish/WSDLfilePath/metadata.xsd");
...
//			}
            ...
            for (Operation operationDO : operations) {
                ...
                String reqOperationTypeName = "d:Req" + tmpOperationId + "BodyType";
                reqOperation.addAttribute("type", reqOperationTypeName);
                Element reqOperationType = schemaRoot.addElement(QN_COMPLEX_TYPE);
                reqOperationType.addAttribute("name", "Req" + tmpOperationId + "BodyType");
                ...
                reqSvcHeaderElem.addAttribute("type", "d:ReqSvcHeaderType");
                ...
                String rspOperationTypeName = "d:Rsp" + tmpOperationId + "BodyType";
                rspOperation.addAttribute("type", rspOperationTypeName);
                Element rspOperationType = schemaRoot.addElement(QN_COMPLEX_TYPE);
                rspOperationType.addAttribute("name", "Rsp" + tmpOperationId + "BodyType");
                ...
                rspSvcHeaderElem.addAttribute("type", "d:RspSvcHeaderType");
    ...
    public void renderSDA(SDAVO sda, Element parentElem, Element typeParentElem) throws DataException {
        ...
        if (null != sdaNode) {
            ...
            if ("array".equalsIgnoreCase(nodeType) || isComplexNode) {
                ...
                nodeElement.addAttribute("type", "d:" + sdaNode.getStructId() + "Type");

 ...
 */
@Component
public class OldSpdbWSDLGenerator implements WSDLGenerator<List<Service>> {
    private static final Log log = LogFactory.getLog(OldSpdbWSDLGenerator.class);
    @Autowired
    private ServiceManagerImpl serviceManager;
    @Autowired
    private OldSpdbServiceSchemaGenerator serviceSchemaGenerator;
    @Autowired
...
//        String workspacePath = getWorkSpace();File.separator + 

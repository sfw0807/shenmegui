...
import com.dc.esb.servicegov.entity.ServiceHeadRelate;
import com.dc.esb.servicegov.resource.IParse;
import com.dc.esb.servicegov.resource.node.Node;
import com.dc.esb.servicegov.resource.util.ExcelHelper;
...
public class ServiceParse implements IParse {
    ...
    private void insertService() {
        ...
        if (GlobalImport.operateFlag) {
            com.dc.esb.servicegov.entity.Service tmpService = serviceDAO.findUniqueBy("serviceId", serviceId);
            if (tmpService != null) {

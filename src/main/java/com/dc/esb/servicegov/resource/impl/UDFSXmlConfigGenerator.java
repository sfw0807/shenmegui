 ...
 */
@Component(value="UDFSXmlConfigGenerator")
public class UDFSXmlConfigGenerator implements IConfigGenerater<InvokeInfo, List<File>> {
    ...
    //跟节点名称
    private static final String ROOTSTRING = "ebank";
...
//        include_attr.add("scale");
    ...
    public Document metadataNode2DocumentWithInclude(IMetadataNode node, List<String> attrInclude,
        ...
        root.addAttribute("encoding", "gb2312");

...
import com.dc.esb.servicegov.service.ServiceCategoryManager;
import com.dc.esb.servicegov.vo.ServiceTotalVO;
...
public class ServiceCategoryManagerImpl implements ServiceCategoryManager {
	...
	public List<com.dc.esb.servicegov.entity.Service> getServiceByCategoryId(String categoryId) {
		List<com.dc.esb.servicegov.entity.Service> serviceList = serviceDAO.findBy("categoryId", categoryId);
		return serviceList;
	}
}

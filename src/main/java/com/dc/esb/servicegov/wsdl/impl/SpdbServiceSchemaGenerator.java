...
//            List<Service> sHeadServices = serviceManager.getServiceById("SHEAD");
            ...
            if (null != sHeadServices) {
                ...
                if (null != sHeadService) {
                    ...
                    for (SDA childSDA : childSDAs) {
                        if ("request".equalsIgnoreCase(childSDA.getValue().getStructName())) {
                            reqSDA = childSDA;
                        }
                        if ("response".equalsIgnoreCase(childSDA.getValue().getStructName())) {
                            rspSDA = childSDA;
                        }
                    }
                    ...
                    for (SDA reqChildSDA : reqChildSDAs) {
                        if ("ReqSvcHeader".equalsIgnoreCase(reqChildSDA.getValue().getStructName())) {
                    ...
                    for (SDA rspChildSDA : rspChildSDAs) {
                        if ("RspSvcHeader".equalsIgnoreCase(rspChildSDA.getValue().getStructName())) {
            ...
            for (Service operationDO : operations) {
                ...
                SDA svcBodySDA = null;
                for (SDA reqChildSDA : reqChildSDAs) {
                    if ("svcbody".equalsIgnoreCase(reqChildSDA.getValue().getStructName())) {
                ...
                for (SDA rspChildSDA : rspChildSDAs) {
                    if ("svcbody".equalsIgnoreCase(rspChildSDA.getValue().getStructName())) {
...
//            BufferedOutputStream wsdlOut = new BufferedOutputStream(new FileOutputStream(wsdlFile));
    ...
    public void renderSDA(SDA sda, Element parentElem, Element typeParentElem) throws DataException {
        //数组
        ...
        if (null != sdaNode) {
            ...
            if ("array".equalsIgnoreCase(nodeType) || isComplexNode) {
                ...
                parseStruct(sdaNode.getMetadtaId(), sequence, typeParentElem);
            } else {
                String metadataId = sdaNode.getMetadtaId();
                if (null != metadataId) {

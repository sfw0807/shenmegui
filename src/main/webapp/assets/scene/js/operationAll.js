$(function () {
    ...
    var consumerInterface = $("#consumerInterface"),
        consumerProtocal = $("#consumerProtocal"),
        providerInterface = $("#providerInterface"),
        providerProtocal = $("#providerProtocal"),
        allFields = $([]).add(consumerInterface).add(consumerProtocal).add(providerInterface).add(providerProtocal),
        tips = $(".validateTips");

    var dialog = $("#configExportDialog").dialog({
        autoOpen: false,
        height: 300,
        width: 350,
        modal: true,
    ...
    $('#exportConfigBtn').button().click(function () {
        dialog.dialog("open");

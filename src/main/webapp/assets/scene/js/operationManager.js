...
var operationManager = {
    ...
    deleteOperationAllSLA : function (serviceId, operationId, callBack) {
        $.ajax({
            url: '../operationInfo/deleteSLA/' +serviceId+"/"+operationId,
            type: 'GET',
            success: function(result) {
                callBack(result);
            }
    ...
    deleteOperationAllOLA : function (serviceId, operationId, callBack) {
        $.ajax({
            url: '../operationInfo/deleteOLA/' +serviceId+"/"+operationId,
            type: 'GET',
            success: function(result) {
                callBack(result);
            }

...
//      if( !data.key ){
	...
	_getInnerHtml: function() {
		var tree = this.tree,
			...
			res = "",
			imageSrc;
		// adapter (expanded, expandable or simple)
		if( level < opts.minExpandLevel ) {
			if(level > 1){
				res += cache.tagConnector;
			}
			// .. else (i.e. for root level) skip expander/adapter altogether
...
//                  }
				...
				// set node adapter images, links and text
...
//      document: "dynatree-document",
		...
		connector: "dynatree-adapter",
		checkbox: "dynatree-checkbox",
		nodeIcon: "dynatree-icon",
		title: "dynatree-title",
		noConnector: "dynatree-no-adapter",

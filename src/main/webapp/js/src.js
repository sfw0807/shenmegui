require([
    ...
    continentStore = new ItemFileReadStore({ data: {
        ...
        label: 'name',
        items: [
            { id: 'AF', name:'服务分类1', type:'continent', population:'900 million', area: '30,221,532 sq km',
                timezone: '-1 UTC to +4 UTC',
                children:[ {_reference:'KE'}, {_reference:'SD'}] },
            { id: 'KE', name:'服务子类1', type:'country',
                children:[
                    { id: 'Nairobi', name:'服务1', type:'city' },
                    { id: 'Mombasa', name:'服务2', type:'city' }
                ] },

            { id: 'SD', name:'服务子类2', type:'country',
                children:{_reference:'Khartoum'} },
            { id: 'Khartoum', name:'服务3', type:'city' },
            { id: 'AS', name:'服务分类2', type:'continent',
            ...
            { id: 'OC', name:'服务分类3', type:'continent', population:'21 million',
                children:{_reference:'AU'}},
            { id: 'AU', name:'Australia', type:'country', population:'21 million'},
            { id: 'EU', name:'服务分类4', type:'continent',
            ...
            { id: 'NA', name:'服务分类5', type:'continent',
            ...
            { id: 'SA', name:'服务分类6', type:'continent',

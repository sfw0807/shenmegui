...
<html>
	<head>
       ...
       <script src='<%=path%>/js/jquery.datatables/js/jquery.dataTables.js' type="text/javascript"></script>
		...
		<script src="<%=path%>/js/consumerManager.js" type="text/javascript"></script>
		<script src="<%=path%>/js/consumer.js" type="text/javascript"></script>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="display" id="consumerTable">
					<tfoot>
						<tr>
							...
							<th>
								<input type="text" name="systemAB" id="systemAB" value="系统英文名称"
									class="search_init" />
							</th>
							<th>
								<input type="text" name="systemName" id="systemName" value="系统中文名称"
									class="search_init" />
							</th>
							<th>

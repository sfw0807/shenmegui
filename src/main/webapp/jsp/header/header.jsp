...
<script src="<%=path1%>/js/bootstrap-transition.js"></script>
<script src="<%=path1%>/js/bootstrap-alert.js"></script>
<script src="<%=path1%>/js/bootstrap-modal.js"></script>
<script src="<%=path1%>/js/bootstrap-dropdown.js"></script>
<script src="<%=path1%>/js/bootstrap-scrollspy.js"></script>
<script src="<%=path1%>/js/bootstrap-tab.js"></script>
<script src="<%=path1%>/js/bootstrap-tooltip.js"></script>
<script src="<%=path1%>/js/bootstrap-popover.js"></script>
<script src="<%=path1%>/js/bootstrap-button.js"></script>
<script src="<%=path1%>/js/bootstrap-collapse.js"></script>
<script src="<%=path1%>/js/bootstrap-carousel.js"></script>
<script src="<%=path1%>/js/bootstrap-typeahead.js"></script>
<script src="<%=path1%>/js/bootstrap.min.js"></script>
<script src="<%=path1%>/js/bootstrap.js"></script>
<style>

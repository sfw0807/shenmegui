...
<head>
    <title>SDA查看</title>
    <link href="<%=path%>/assets/interface/css/ida.css" rel="stylesheet"/>
    <script src="<%=path%>/assets/interface/js/idaManager.js"></script>
    <script src="<%=path%>/js/metadataManager.js"></script>
    <script src="<%=path%>/assets/interface/js/ida.js"></script>
</head>
<body style="padding: 4px">
<div>
    <div style="margin: 2px;">
        节点ID: <input type="text" id="idaid" disabled="true"/>
        ...
        英文名称：<input type="text" id="structName"/>

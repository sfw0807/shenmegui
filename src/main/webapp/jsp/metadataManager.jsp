...
<div id="tabs" style="width: 100%">
    ...
    <div id="tabs-0">
        <div class="ui-widget-header" style="margin-bottom: 0.5em;padding:0.5em;">
            ...
            <button id="serviceCallback">服务调用查询</button>
        </div>

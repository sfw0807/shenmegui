...
<html >
	<head>
		...
		<script src="<%=path %>/js/metadataStructs.js" type="text/javascript"></script>
	        ...
	        <table cellpadding="0" cellspacing="0" border="0" class="display"
					...
					<tfoot>
						<tr>
							...
							<th>
								<input type="text" name="structName" id="structName" value="元数据结构名称"
									class="search_init" />
							</th>
							<th>

...
<head>
  ...
  <script src="<%=ctx%>/assets/scene/js/operationManager.js" type="text/javascript"></script>
  <script src="<%=ctx%>/assets/scene/js/editOperation.js" type="text/javascript"></script>
...
<div id="tabs" style="width:100%">
  ...
  <div id="tabs-1">
    <div class="ui-widget-header" style="margin-bottom: 0.5em;padding: 0.2em;">
      <input type="button" value="查看SDA" id="seesdaView" class="ui-button ui-widget ui-state-default ui-corner-all"

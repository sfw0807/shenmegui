...
<html>
	<head>
       ...
       <script src='<%=path%>/js/jquery.datatables/js/jquery.dataTables.js' type="text/javascript"></script>
		...
		<script src="<%=path%>/js/roleAllManager.js" type="text/javascript"></script>
		<script src="<%=path%>/js/roleAll.js" type="text/javascript"></script>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="display" id="roleTable">
					<tfoot>
						<tr>
							...
							<th>
								<input type="hidden" name="serviceId" id="serviceId" value="操作"
									class="search_init" />
							</th>				
						</tr>
					</tfoot>

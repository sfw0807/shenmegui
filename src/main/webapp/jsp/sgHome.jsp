<%@ page language="java" import="com.dc.esb.servicegov.entity.User" pageEncoding="UTF-8" %>
<%
...
<head>
    ...
    <link data-turbolinks-track="true" href="<%=path%>/assets/login/css/sgHome.css" media="all"
          rel="stylesheet"/>
    <script data-turbolinks-track="true" src="<%=path%>/assets/login/js/sgHome.js"></script>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">
                <div class="logo">
                    <img src="<%=path%>/assets/login/images/thumb.png"/>
                </div>
                <p>神州 <br>数码
                </p>
            </a>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                <div class="card">
                    <div class="thumbnail">
                        <img alt="服务管理"
                             src="<%=path%>/assets/login/images/service.png"/>
                        <a href="<%=path%>/jsp/serviceInfoManager.jsp">

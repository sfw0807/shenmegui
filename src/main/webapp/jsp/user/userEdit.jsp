...
<fieldset>
  ...
  <tr>
    <th>用户代码</th>
    <td><input name="userId" class="easyui-textbox" type="text" id="userId" value="${user.id}"  disabled='disabled'/><font color="#FF0000">*</font></td>
    <th>用户名称</th>
    <td><input name="userName" class="easyui-textbox" type="text" id="userName" value="${user.name}"/><font color="#FF0000">*</font></td>
    <th>密 码</th>
    <td><input name="password" class="easyui-textbox" type="text" id="password" value="${user.password}"  disabled='disabled'/><font color="#FF0000">*</font></td>
  </tr>
  <tr>
    <th>手机号码</th>
    <td><input name="userMobile" class="easyui-textbox" type="text" id="userMobile" value="${user.userMobile}"/></td>
    <th>电话号码</th>
  ...
  <tr>
    <th>生效日期</th>
    <td><input name="startdate"  type="text" class="easyui-datebox" id="startdate" value="${user.startdate}"/></td>
    <th>失效日期</th>

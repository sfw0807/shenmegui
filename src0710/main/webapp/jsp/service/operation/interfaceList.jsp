...
<html>
   ...
   <table id="intefaceList" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'interfaceObj.interfaceName', width:100" formatter='ff.interfaceName'>接口名称</th>
  ...
  <tr>
    <td><a href="javascript:void(0)" onclick="$('#opDlg').dialog('close');" class="easyui-linkbutton" iconCls="icon-cancel" plain="true">取消</a>&nbsp;&nbsp;
	    <a href="javascript:void(0)" onclick="selectInterface('<%=request.getParameter("newListId") %>');" class="easyui-linkbutton" iconCls="icon-ok" plain="true">确定</a>
    </td>
    </tr>
    </table>
    </div>

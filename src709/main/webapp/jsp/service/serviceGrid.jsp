...
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
      <th>服务一级目录</th>
    <td> <input class="easyui-textbox" disabled="disabled"  type="text" name="name" ></td>
   
  <th>服务二级目录</th>
    <td> <input class="easyui-textbox" disabled="disabled"  type="text" name="name" >
      </td>
  <th>服务三级目录</th>
    <td> <input class="easyui-textbox" disabled="disabled"  type="text" name="name" ></td>
  </tr>
  <tr>
     <th>服务代码</th>
    <td><input class="easyui-textbox" disabled="disabled" type="text" name="serviceId" value="${entity.serviceId }"></td>
    <th>服务名称</th>
    <td><input class="easyui-textbox" disabled="disabled" type="text" name="serviceName" value="${entity.serviceName }"></td>
     <th> 服务功能描述</th>
    <td> <input class="easyui-textbox" disabled="disabled"  type="text" name="desc" value="${entity.desc }"></td>
  </tr>
  <tr>
     <th>服务关键词</th>
    <td><input class="easyui-textbox" disabled="disabled" type="text" name="remark" value="${entity.remark }"></td>
    <th>&nbsp;</th>
    <td>&nbsp;</td>
     <th>&nbsp;</th>
    <td>&nbsp;</td>
...
<script type="text/javascript">
			...
			handler:function(){
						...
						if(checkedItems != null && checkedItems.length > 0){
							if(checkedItems.length > 1){
								...
								var opeEditContent = ' <iframe scrolling="auto" frameborder="0"  src="'+ urlPath + '" style="width:100%;height:100%;"></iframe>'
		...
		
		{
			...
			iconCls:'icon-qxfp',
			handler:function(){
				var content = '<iframe scrolling="auto" frameborder="0"  src="/dataTemplate/serviceadmin/grid2.html" style="width:100%;height:100%;"></iframe>';
					
				parent.parent.addTab('服务场景', content);
			}
		},
		{
			text:'提交任务',

...
<table id="tt" style="height:370px; width:auto;" title="所有用户"
	...
	<tr>
				...
				<th field="name" width="130px" align="center" editor="text">用户名称</th>
				<th field="userMobile" width="130px" align="center" editor="text">手机号码</th>
				<th field="userTel" width="130px" align="center" editor="text">电话号码</th>
				<th field="orgId" width="130px" align="center" editor="text">所属机构</th>
				<th field="startdate" width="130px" align="center" editor="text">生效日期</th>
				<th field="lastdate" width="130px" align="center" editor="text">失效日期</th>
				<th field="remark" width="130px" align="center" editor="text">备 注</th>
	</tr>
	</thead>
</table>
